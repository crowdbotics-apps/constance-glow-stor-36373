...
## Project Structure
    ...
    ├── constance_glow_stor_36373  # Django project configurations
...
1. Clone this repo and `cd constance_glow_stor_36373`
...
2. Clone this repo and `cd constance_glow_stor_36373`
